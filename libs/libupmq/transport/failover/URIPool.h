...
#ifndef _UPMQ_URI_POOL_H_
#define _UPMQ_URI_POOL_H_
...
class UPMQCPP_API URIPool {
 ...
 public:
   ...
   */
  const decaf::util::List<decaf::net::URI> &getURIList() const { return this->uriPool; }
   ...
   */
  const decaf::net::URI &getPriorityURI() const { return this->priorityURI; }
   ...
   */
  void setPriorityURI(const decaf::net::URI &uri) { this->priorityURI = uri; }
   ...
   */
  bool isRandomize() const { return this->randomize; }
   ...
   */
  void setRandomize(bool value) { this->randomize = value; }
