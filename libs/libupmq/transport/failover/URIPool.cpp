...
URIPool::URIPool(const URIPool &uris) : uriPool(), priorityURI(), randomize(false) {
  synchronized(&uris.uriPool) { this->uriPool.copy(uris.uriPool); }
...
bool URIPool::contains(const decaf::net::URI &uri) const {
  bool result = false;
  synchronized(&uriPool) { result = uriPool.contains(uri); }
...
////////////////////////////////////////////////////////////////////////////////
void URIPool::clear() {
  synchronized(&uriPool) { this->uriPool.clear(); }
}

////////////////////////////////////////////////////////////////////////////////
bool URIPool::isEmpty() const {
  bool result = true;
  synchronized(&uriPool) { result = this->uriPool.isEmpty(); }
  return result;
}
...
bool URIPool::equals(const URIPool &other) const {
  ...
  synchronized(&other.uriPool) { others.copy(other.uriPool); }

  synchronized(&this->uriPool) { mine.copy(this->uriPool); }
