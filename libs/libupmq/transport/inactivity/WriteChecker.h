...
#ifndef _UPMQ_TRANSPORT_INACTIVITY_WRITECHECKER_H_
#define _UPMQ_TRANSPORT_INACTIVITY_WRITECHECKER_H_
 ...
 * @since 3.1.0
 */
class UPMQCPP_API WriteChecker : public decaf::util::TimerTask {
 private:
...
#endif /* _UPMQ_TRANSPORT_INACTIVITY_WRITECHECKER_H_ */
