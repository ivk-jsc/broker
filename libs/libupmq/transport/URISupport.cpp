...
void URISupport::parseURL(const std::string &URI, decaf::util::Properties &properties) {
  try {
    ...
    if (tokenizer.countTokens() < 3) {
      throw decaf::lang::exceptions::IllegalArgumentException(__FILE__,
                                                              __LINE__,
...
////////////////////////////////////////////////////////////////////////////////
URI URISupport::stripScheme(const URI &uri) { return URI(stripPrefix(uri.getSchemeSpecificPart(), "//")); }
...
////////////////////////////////////////////////////////////////////////////////
URI URISupport::applyParameters(const URI &uri, const Properties &queryParameters) { return applyParameters(uri, queryParameters, ""); }
