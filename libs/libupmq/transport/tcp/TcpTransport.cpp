...
void TcpTransport::connect() {
  try {
    ...
    if (ioTransport == nullptr) {
      throw UPMQException(__FILE__,
                          __LINE__,
                          "TcpTransport::TcpTransport - "
...
bool TcpTransport::isConnected() const {
  if (this->impl->socket.get() != nullptr) {
...
////////////////////////////////////////////////////////////////////////////////
void TcpTransport::setConnectTimeout(int soConnectTimeout) { this->impl->connectTimeout = soConnectTimeout; }

////////////////////////////////////////////////////////////////////////////////
int TcpTransport::getConnectTimeout() const { return this->impl->connectTimeout; }

////////////////////////////////////////////////////////////////////////////////
void TcpTransport::setOutputBufferSize(int outputBufferSize) { this->impl->outputBufferSize = outputBufferSize; }

////////////////////////////////////////////////////////////////////////////////
int TcpTransport::getOutputBufferSize() const { return this->impl->outputBufferSize; }

////////////////////////////////////////////////////////////////////////////////
void TcpTransport::setInputBufferSize(int inputBufferSize) { this->impl->inputBufferSize = inputBufferSize; }

////////////////////////////////////////////////////////////////////////////////
int TcpTransport::getInputBufferSize() const { return this->impl->inputBufferSize; }

////////////////////////////////////////////////////////////////////////////////
void TcpTransport::setTrace(bool trace) { this->impl->trace = trace; }

////////////////////////////////////////////////////////////////////////////////
bool TcpTransport::isTrace() const { return this->impl->trace; }

////////////////////////////////////////////////////////////////////////////////
void TcpTransport::setLinger(int soLinger) { this->impl->soLinger = soLinger; }

////////////////////////////////////////////////////////////////////////////////
int TcpTransport::getLinger() const { return this->impl->soLinger; }

////////////////////////////////////////////////////////////////////////////////
void TcpTransport::setKeepAlive(bool soKeepAlive) { this->impl->soKeepAlive = soKeepAlive; }

////////////////////////////////////////////////////////////////////////////////
bool TcpTransport::isKeepAlive() const { return this->impl->soKeepAlive; }

////////////////////////////////////////////////////////////////////////////////
void TcpTransport::setReceiveBufferSize(int soReceiveBufferSize) { this->impl->soReceiveBufferSize = soReceiveBufferSize; }

////////////////////////////////////////////////////////////////////////////////
int TcpTransport::getReceiveBufferSize() const { return this->impl->soReceiveBufferSize; }

////////////////////////////////////////////////////////////////////////////////
void TcpTransport::setSendBufferSize(int soSendBufferSize) { this->impl->soSendBufferSize = soSendBufferSize; }

////////////////////////////////////////////////////////////////////////////////
int TcpTransport::getSendBufferSize() const { return this->impl->soSendBufferSize; }

////////////////////////////////////////////////////////////////////////////////
void TcpTransport::setTcpNoDelay(bool tcpNoDelay) { this->impl->tcpNoDelay = tcpNoDelay; }

////////////////////////////////////////////////////////////////////////////////
bool TcpTransport::isTcpNoDelay() const { return this->impl->tcpNoDelay; }

////////////////////////////////////////////////////////////////////////////////
decaf::net::URI TcpTransport::getLocation() const { return this->impl->location; }
