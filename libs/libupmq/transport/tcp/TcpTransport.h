...
#ifndef _UPMQ_TRANSPORT_TCP_TCPTRANSPORT_H_
#define _UPMQ_TRANSPORT_TCP_TCPTRANSPORT_H_
 ...
 */
class UPMQCPP_API TcpTransport : public TransportFilter {
 private:
 ...
 public:
   ...
   */
  TcpTransport(Pointer<Transport> next, const decaf::net::URI &location);
 ...
 protected:
  ...
  void beforeNextIsStarted() override;

  void afterNextIsStopped() override;
...
#endif /*_UPMQ_TRANSPORT_TCP_TCPTRANSPORT_H_*/
