...
class CMS_API Session : public Closeable, public Startable, public Stoppable {
 ...
 public:
   ...
   * @throws InvalidDestinationException - if an invalid destination is specified.
   */
  virtual MessageProducer *createProducer(const Destination *destination = nullptr) = 0;
   ...
   * @throws CMSException - If an internal error occurs.
   */
  virtual ObjectMessage *createObjectMessage() = 0;
   ...
   * @throws CMSException - If an internal error occurs.
   */
  virtual ObjectMessage *createObjectMessage(const std::string &text) = 0;
