...
class CMS_API MessageFormatException : public CMSException {
 public:
  ...
  MessageFormatException(const MessageFormatException &ex) noexcept;

  MessageFormatException(MessageFormatException &&ex) noexcept;

  MessageFormatException &operator=(const cms::MessageFormatException &) = delete;

  MessageFormatException &operator=(cms::MessageFormatException &&) = delete;
  ...
  MessageFormatException *clone() override;
};
}  // namespace cms
