...
class CMS_API Message {
 public:
   ...
   */
  static const int DEFAULT_DELIVERY_MODE = cms::DeliveryMode::PERSISTENT;

  /**
   * The Default priority assigned to a Message is 4.
   */
  static const int DEFAULT_MSG_PRIORITY = 4;
 ...
 public:
   ...
   * @throws MessageFormatException - if this type conversion is invalid.
   */
  virtual signed char getByteProperty(const std::string &name) const = 0;
   ...
   * @throws MessageNotWriteableException - if properties are read-only
   */
  virtual void setByteProperty(const std::string &name, signed char value) = 0;
   ...
   */
  virtual int getBytesProperty(const std::string &name, unsigned char *buffer, int length) const = 0;
   ...
   */
  virtual void setBytesProperty(const std::string &name, const unsigned char *value, int length) = 0;

  virtual void *getProtoUnpackedBody() = 0;
  virtual long long getProtoUnpackedBodySize() = 0;

  virtual bool isExpired() = 0;

  /**
   * Makes message properties and message body readable.
   *
   */
  virtual void setReadable() = 0;

  /**
   * Makes message properties and message body writable.
   *
   */
