...
class CMS_API MessageNotReadableException : public CMSException {
 public:
  ...
  MessageNotReadableException(const MessageNotReadableException &ex) noexcept;

  MessageNotReadableException(MessageNotReadableException &&ex) noexcept;

  MessageNotReadableException &operator=(const cms::MessageNotReadableException &) = delete;

  MessageNotReadableException &operator=(cms::MessageNotReadableException &&) = delete;
  ...
  MessageNotReadableException *clone() override;
};
}  // namespace cms
