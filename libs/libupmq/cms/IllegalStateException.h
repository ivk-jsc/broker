...
class CMS_API IllegalStateException : public CMSException {
 public:
  ...
  IllegalStateException(const IllegalStateException &ex) noexcept;

  IllegalStateException(IllegalStateException &&ex) noexcept;

  IllegalStateException &operator=(const cms::IllegalStateException &) = delete;

  IllegalStateException &operator=(cms::IllegalStateException &&) = delete;
  ...
  IllegalStateException *clone() override;
};
}  // namespace cms
