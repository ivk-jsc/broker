...
class CMS_API MessageNotWriteableException : public CMSException {
 public:
  ...
  MessageNotWriteableException(const MessageNotWriteableException &ex) noexcept;

  MessageNotWriteableException(MessageNotWriteableException &&ex) noexcept;

  MessageNotWriteableException &operator=(const cms::MessageNotWriteableException &) = delete;

  MessageNotWriteableException &operator=(cms::MessageNotWriteableException &&) = delete;
  ...
  MessageNotWriteableException *clone() override;
};
}  // namespace cms
