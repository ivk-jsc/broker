...
////////////////////////////////////////////////////////////////////////////////
IllegalStateException::IllegalStateException(const IllegalStateException &ex) noexcept = default;

////////////////////////////////////////////////////////////////////////////////
IllegalStateException::IllegalStateException(IllegalStateException &&ex) noexcept = default;

////////////////////////////////////////////////////////////////////////////////
IllegalStateException::IllegalStateException(const std::string &message) : CMSException(message, nullptr) {}
...
////////////////////////////////////////////////////////////////////////////////
IllegalStateException *IllegalStateException::clone() { return new IllegalStateException(*this); }
