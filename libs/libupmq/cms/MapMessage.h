...
class CMS_API MapMessage : public Message {
 public:
   ...
   */
  virtual void setByte(const std::string &name, char value) = 0;
   ...
   * @throws MessageFormatException - if this type conversion is invalid.
   */
  virtual std::vector<signed char> getBytes(const std::string &name) const = 0;
   ...
   * @throws MessageNotWriteableException - if the Message is in Read-only Mode.
   */
  virtual void setBytes(const std::string &name, const std::vector<signed char> &value) = 0;
   ...
   * @throws MessageFormatException - if this type conversion is invalid.
   */
  virtual unsigned short getChar(const std::string &name) const = 0;
   ...
   * @throws MessageNotWriteableException - if the Message is in Read-only Mode.
   */
  virtual void setChar(const std::string &name, unsigned short value) = 0;
