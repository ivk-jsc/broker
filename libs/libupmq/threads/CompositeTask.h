...
#ifndef _UPMQ_THREADS_COMPOSITETASK_H_
#define _UPMQ_THREADS_COMPOSITETASK_H_
 ...
 * @since 3.0
 */
class UPMQCPP_API CompositeTask : public upmq::threads::Task {
 public:
...
#endif /* _UPMQ_THREADS_COMPOSITETASK_H_ */
