...
////////////////////////////////////////////////////////////////////////////////
UUID::UUID(const UUID &source) : uuid(new UUIDImpl(source.getMostSignificantBits(), source.getLeastSignificantBits())) {}
...
////////////////////////////////////////////////////////////////////////////////
bool UUID::operator==(const UUID &value) const { return this->equals(value); }

////////////////////////////////////////////////////////////////////////////////
bool UUID::operator<(const UUID &value) const { return this->compareTo(value) == -1 ? true : false; }

////////////////////////////////////////////////////////////////////////////////
std::string UUID::toString() const { return this->uuid->toString(); }

////////////////////////////////////////////////////////////////////////////////
long long UUID::getLeastSignificantBits() const { return this->uuid->leastSigBits; }

////////////////////////////////////////////////////////////////////////////////
long long UUID::getMostSignificantBits() const { return this->uuid->mostSigBits; }

////////////////////////////////////////////////////////////////////////////////
long long UUID::node() {
  if (this->version() != 1) {
    throw exceptions::UnsupportedOperationException(__FILE__, __LINE__, "UUID::node - Only a Version 1 UUID supports this operation.");
  }
...
////////////////////////////////////////////////////////////////////////////////
int UUID::version() { return this->uuid->version; }
...
UUID UUID::nameUUIDFromBytes(const std::vector<char> &name) {
  if (!name.empty()) {
    ...
    return UUID::nameUUIDFromBytes(nullptr, 0);
  }
}
...
UUID UUID::nameUUIDFromBytes(const char *name, int size) {
  ...
  try {
    ...
    throw exceptions::RuntimeException(__FILE__, __LINE__, "UUID::nameUUIDFromBytes - Failed to run MD5 encoder.");
  }
...
UUID UUID::fromString(const std::string &uuid) {
  ...
  if (i != POS_SIZE || lastPosition != -1) {
    throw IllegalArgumentException(__FILE__, __LINE__, "Invalid UUID string %s", uuid.c_str());
  }
