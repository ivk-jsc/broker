 ...
 */
template <typename E>
class AbstractQueue : public decaf::util::Queue<E>, public decaf::util::AbstractCollection<E> {
 public:
  ...
  virtual bool add(const E &value) {
    ...
    throw decaf::lang::exceptions::IllegalStateException(__FILE__, __LINE__, "Unable to add specified element to the Queue.");
  }
  ...
  virtual bool addAll(const Collection<E> &collection) {
    if (this == &collection) {
      throw decaf::lang::exceptions::IllegalArgumentException(__FILE__, __LINE__, "A Queue cannot be added to itself.");
    }
  ...
  virtual E remove() {
    ...
    throw decaf::util::NoSuchElementException(__FILE__, __LINE__, "Unable to remove specified element from the Queue.");
  }
