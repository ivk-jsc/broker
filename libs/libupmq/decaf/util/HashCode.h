...
struct HashCode : HashCodeUnaryBase<const T &> {
 public:
  int operator()(const T &arg) const { return arg.getHashCode(); }
};
...
struct HashCode<unsigned long long> : public HashCodeUnaryBase<unsigned long long> {
  int operator()(unsigned long long arg) const { return (int)(arg ^ (arg >> 32)); }
};

template <>
struct HashCode<long long> : public HashCodeUnaryBase<long long> {
  int operator()(long long arg) const { return (int)((unsigned long long)arg ^ ((unsigned long long)arg >> 32)); }
};

template <>
struct HashCode<float> : public HashCodeUnaryBase<float> {
  int operator()(float arg) const { return decaf::lang::Float::floatToIntBits(arg); }
};
