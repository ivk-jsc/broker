...
class MapEntry {
 ...
 public:
  ...
  virtual void setKey(K newKey) { this->key = newKey; }

  virtual K &getKey() { return this->key; }

  virtual const K &getKey() const { return this->key; }

  virtual void setValue(const V &newValue) { this->value = newValue; }

  virtual V &getValue() { return this->value; }

  virtual const V &getValue() const { return this->value; }
  ...
  virtual bool operator==(const MapEntry<K, V> &other) const { return this->equals(other); }
};
}  // namespace util
}  // namespace decaf
