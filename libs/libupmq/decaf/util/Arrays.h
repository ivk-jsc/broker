...
class Arrays {
 ...
 public:
  ...
  static void fill(E *array, int size, const E &value) {
    if (array == nullptr) {
      throw decaf::lang::exceptions::NullPointerException(__FILE__, __LINE__, "Array pointer given was NULL.");
    }

    if (size < 0) {
      throw decaf::lang::exceptions::IllegalArgumentException(__FILE__, __LINE__, "Array size value given was negative.");
    }
  ...
  static void fill(E *array, int size, int start, int end, const E &value) {
    ...
    if (start > end) {
      throw decaf::lang::exceptions::IllegalArgumentException(__FILE__, __LINE__, "The start index was greater than the end index.");
    }
