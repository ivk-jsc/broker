...
////////////////////////////////////////////////////////////////////////////////
const TimeUnit *const TimeUnit::values[] = {&NANOSECONDS, &MICROSECONDS, &MILLISECONDS, &SECONDS, &MINUTES, &HOURS, &DAYS};
...
////////////////////////////////////////////////////////////////////////////////
TimeUnit::TimeUnit(int index_, const std::string &name_) : index(index_), name(name_) {}
...
long long TimeUnit::doConvert(int srcIndex, int destIndex, long long duration) const {
  if (duration == 0) {
    ...
    return scale(duration, multipliers[srcIndex] / multipliers[destIndex], Long::MAX_VALUE / (multipliers[srcIndex] / multipliers[destIndex]));
  } else if (srcIndex < destIndex) {
...
void TimeUnit::timedWait(Synchronizable *obj, long long timeout) const {
  if (obj == nullptr) {
    throw NullPointerException(__FILE__, __LINE__, "Synchronizable object pointer was null.");
  }
...
void TimeUnit::timedJoin(Thread *thread, long long timeout) {
  if (thread == nullptr) {
    throw NullPointerException(__FILE__, __LINE__, "Thread object pointer was null.");
  }
...
////////////////////////////////////////////////////////////////////////////////
std::string TimeUnit::toString() const { return this->name; }

////////////////////////////////////////////////////////////////////////////////
int TimeUnit::compareTo(const TimeUnit &value) const { return index == value.index ? 0 : (index > value.index ? 1 : -1); }

////////////////////////////////////////////////////////////////////////////////
bool TimeUnit::equals(const TimeUnit &value) const { return index == value.index; }

////////////////////////////////////////////////////////////////////////////////
bool TimeUnit::operator==(const TimeUnit &value) const { return index == value.index; }

////////////////////////////////////////////////////////////////////////////////
bool TimeUnit::operator<(const TimeUnit &value) const { return this->compareTo(value) == -1; }
...
const TimeUnit &TimeUnit::valueOf(const std::string &name) {
  ...
  throw IllegalArgumentException(__FILE__, __LINE__, "Passed TimeUnit name; %s, Does not match any instances of TimeUnit", name.c_str());
}
