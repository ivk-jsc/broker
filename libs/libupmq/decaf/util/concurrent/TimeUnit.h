...
class DECAF_API TimeUnit : public decaf::lang::Comparable<TimeUnit> {
 ...
 public:
   ...
   * @see #convert
   */
  long long toNanos(long long duration) const { return doConvert(this->index, NANOSECONDS.index, duration); }
   ...
   * @see #convert
   */
  long long toMicros(long long duration) const { return doConvert(this->index, MICROSECONDS.index, duration); }
   ...
   * @see #convert
   */
  long long toMillis(long long duration) const { return doConvert(this->index, MILLISECONDS.index, duration); }
   ...
   * @see #convert
   */
  long long toSeconds(long long duration) const { return doConvert(this->index, SECONDS.index, duration); }
   ...
   * @see #convert
   */
  long long toMinutes(long long duration) const { return doConvert(this->index, MINUTES.index, duration); }
   ...
   * @see #convert
   */
  long long toHours(long long duration) const { return doConvert(this->index, HOURS.index, duration); }
   ...
   * @see #convert
   */
  long long toDays(long long duration) const { return doConvert(this->index, DAYS.index, duration); }
