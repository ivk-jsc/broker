 ...
 public:
  ...
  bool nonfairTryAcquire(int acquires) {
    ...
    if (c == 0) {
      ...
      if (nextc < 0) {
        throw RuntimeException(__FILE__, __LINE__, "Maximum lock count exceeded");
      }
  ...
  Condition *getNewCondition() { return AbstractQueuedSynchronizer::createDefaultConditionObject(); }

  Thread *getOwner() const { return getState() == 0 ? nullptr : getExclusiveOwnerThread(); }

  int getHoldCount() const { return isHeldExclusively() ? getState() : 0; }

  bool isLocked() const { return getState() != 0; }

  bool isHeldExclusively() const { return getExclusiveOwnerThread() == Thread::currentThread(); }
...
class NonFairSync : public Sync {
 ...
 public:
  virtual bool isFair() const { return false; }
 ...
 protected:
  virtual bool tryAcquire(int acquires) { return this->nonfairTryAcquire(acquires); }
};
...
class FairSync : public Sync {
 ...
 public:
  virtual void lock() { this->acquire(1); }

  virtual bool isFair() const { return true; }
...
////////////////////////////////////////////////////////////////////////////////
ReentrantLock::ReentrantLock(bool fair) : Lock(), sync(nullptr) { fair == true ? sync = new FairSync() : sync = new NonFairSync(); }
...
////////////////////////////////////////////////////////////////////////////////
void ReentrantLock::lock() { this->sync->lock(); }

////////////////////////////////////////////////////////////////////////////////
void ReentrantLock::lockInterruptibly() { this->sync->acquireInterruptibly(1); }

////////////////////////////////////////////////////////////////////////////////
bool ReentrantLock::tryLock() { return this->sync->nonfairTryAcquire(1); }

////////////////////////////////////////////////////////////////////////////////
bool ReentrantLock::tryLock(long long time, const TimeUnit &unit) { return this->sync->tryAcquireNanos(1, unit.toNanos(time)); }

////////////////////////////////////////////////////////////////////////////////
void ReentrantLock::unlock() { this->sync->release(1); }

////////////////////////////////////////////////////////////////////////////////
Condition *ReentrantLock::newCondition() { return this->sync->getNewCondition(); }

////////////////////////////////////////////////////////////////////////////////
int ReentrantLock::getHoldCount() const { return this->sync->getHoldCount(); }

////////////////////////////////////////////////////////////////////////////////
bool ReentrantLock::isHeldByCurrentThread() const { return this->sync->isHeldExclusively(); }

////////////////////////////////////////////////////////////////////////////////
bool ReentrantLock::isLocked() const { return this->sync->isLocked(); }

////////////////////////////////////////////////////////////////////////////////
bool ReentrantLock::isFair() const { return this->sync->isFair(); }
...
////////////////////////////////////////////////////////////////////////////////
decaf::lang::Thread *ReentrantLock::getOwner() const { return this->sync->getOwner(); }

////////////////////////////////////////////////////////////////////////////////
int ReentrantLock::getQueueLength() const { return this->sync->getQueueLength(); }

////////////////////////////////////////////////////////////////////////////////
Collection<decaf::lang::Thread *> *ReentrantLock::getQueuedThreads() const { return this->sync->getQueuedThreads(); }

////////////////////////////////////////////////////////////////////////////////
bool ReentrantLock::hasQueuedThreads() const { return this->sync->hasQueuedThreads(); }
...
int ReentrantLock::getWaitQueueLength(Condition *condition) const {
  ...
  const AbstractQueuedSynchronizer::ConditionObject *cond = dynamic_cast<const AbstractQueuedSynchronizer::ConditionObject *>(condition);
