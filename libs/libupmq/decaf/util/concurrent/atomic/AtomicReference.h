...
class AtomicReference {
 ...
 public:
   ...
   */
  void set(T *newValue) { internal::util::concurrent::Atomics::getAndSet(&this->value, (void *)newValue); }
   ...
   */
  T *getAndSet(T *newValue) { return (T *)internal::util::concurrent::Atomics::getAndSet(&this->value, (void *)newValue); }

  /**
   * Returns the String representation of the current value.
   * @return string representation of the current value.
   */
  std::string toString() const { return decaf::lang::Long::toString((long long)this->value); }
};
}  // namespace atomic
}  // namespace concurrent
}  // namespace util
