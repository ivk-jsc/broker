...
////////////////////////////////////////////////////////////////////////////////
bool AtomicBoolean::getAndSet(bool newValue) { return Atomics::getAndSet(&this->value, newValue) > 0; }

////////////////////////////////////////////////////////////////////////////////
std::string AtomicBoolean::toString() const { return Boolean::toString(this->value != 0); }
