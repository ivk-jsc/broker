...
////////////////////////////////////////////////////////////////////////////////
float Random::nextFloat() { return ((float)next(24) / 16777216.0f); }
...
int Random::nextInt(int n) {
  ...
  throw exceptions::IllegalArgumentException(__FILE__, __LINE__, "Value passed cannot be less than or equal to zero.");
}

////////////////////////////////////////////////////////////////////////////////
long long Random::nextLong() { return ((long long)next(32) << 32) + next(32); }
...
void Random::setSeed(unsigned long long newSeed) {
  ...
  mask <<= 31;
  mask <<= 17;
  this->seed = (newSeed ^ multiplier) & (mask - 1);
  haveNextNextGaussian = false;
}
