...
class ArrayList : public decaf::util::AbstractList<E> {
 ...
 public:
  ArrayList() : AbstractList<E>(), elements(nullptr), capacity(0), head(0), curSize(0) { this->ensureCapacity(10); }

  ArrayList(const Collection<E> &collection) : AbstractList<E>(), elements(nullptr), capacity(0), head(0), curSize(0) {
  ...
  ArrayList(const ArrayList<E> &arrayList) : AbstractList<E>(), elements(nullptr), capacity(0), head(0), curSize(0) {
  ...
  ArrayList(int initialCapacity) : AbstractList<E>(), elements(nullptr), capacity(initialCapacity), head(0), curSize(0) {
 ...
 public:
  ...
  bool operator==(const ArrayList<E> &other) const { return this->equals(other); }
 ...
 public:
  ...
  virtual bool isEmpty() const { return this->curSize == 0; }

  virtual int size() const { return this->curSize; }

  virtual E set(int index, const E &element) {
    if (index < 0 || index >= this->curSize) {
      throw decaf::lang::exceptions::IndexOutOfBoundsException(__FILE__, __LINE__, "Index greater than size() or negative");
    }
  ...
  virtual void add(int index, const E &element) {
    if (index < 0 || index > this->curSize) {
      throw decaf::lang::exceptions::IndexOutOfBoundsException(__FILE__, __LINE__, "Index was negative or greater than size()");
    }
  ...
  virtual bool addAll(int index, const Collection<E> &collection) {
    if (index < 0 || index > this->curSize) {
      throw decaf::lang::exceptions::IndexOutOfBoundsException(__FILE__, __LINE__, "Index greater than size()");
    }
  ...
  virtual bool contains(const E &value) const { return this->indexOf(value) != -1; }
