...
class DECAF_API Buffer {
 ...
 public:
   ...
   */
  virtual int position() const { return this->_position; }
   ...
   */
  virtual int limit() const { return this->_limit; }
   ...
   */
  virtual int remaining() const { return _limit - _position; }
   ...
   *          this buffer.
   */
  virtual bool hasRemaining() const { return remaining() != 0; }
