...
////////////////////////////////////////////////////////////////////////////////
void InputStream::mark(int readLimit DECAF_UNUSED) { DECAF_UNUSED_VAR(readLimit); }

////////////////////////////////////////////////////////////////////////////////
std::string InputStream::toString() const { return typeid(this).name(); }

////////////////////////////////////////////////////////////////////////////////
void InputStream::reset() { throw IOException(__FILE__, __LINE__, "Base InputStream class does not support Reset."); }
...
////////////////////////////////////////////////////////////////////////////////
int InputStream::doReadArrayBounded(unsigned char *pbuffer, int size, int offset, int length) {
  try {
    if (length == 0) {
      return 0;
    }
    ...
    for (int i = 0; i < length; i++) {
      ...
      pbuffer[offset + i] = (unsigned char)c;
    }
