...
////////////////////////////////////////////////////////////////////////////////
FilterInputStream::FilterInputStream(InputStream *inputStream_, bool own_)
    : InputStream(), inputStream(inputStream_), own(own_), closed(inputStream == nullptr) {}
...
////////////////////////////////////////////////////////////////////////////////
int FilterInputStream::doReadArrayBounded(unsigned char *pbuffer, int size, int offset, int length) {
  try {
    if (isClosed()) {
      throw IOException(__FILE__, __LINE__, "FilterInputStream::doReadArrayBounded - Stream is closed");
    }

    return inputStream->read(pbuffer, size, offset, length);
  }
  DECAF_CATCH_RETHROW(IOException)
  DECAF_CATCH_RETHROW(NullPointerException)
...
////////////////////////////////////////////////////////////////////////////////
bool FilterInputStream::isClosed() const { return this->closed || this->inputStream == nullptr; }
