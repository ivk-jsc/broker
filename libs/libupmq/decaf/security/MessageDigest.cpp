...
////////////////////////////////////////////////////////////////////////////////
MessageDigest::MessageDigest(const std::string &name) : impl(nullptr), spi(), provider(), algorithm(name) {}
...
MessageDigest *MessageDigest::getInstance(const std::string &algorithm) {
  ...
  if (spi == nullptr) {
    delete newSpi;
    throw NoSuchAlgorithmException(__FILE__, __LINE__, "Supplied algorithm not a MessageDigest algorithm.");
  }
...
////////////////////////////////////////////////////////////////////////////////
bool MessageDigest::isEqual(const std::vector<unsigned char> &digesta, const std::vector<unsigned char> &digestb) {
...
////////////////////////////////////////////////////////////////////////////////
std::vector<unsigned char> MessageDigest::digest() { return this->spi->engineDigest(); }

////////////////////////////////////////////////////////////////////////////////
int MessageDigest::digest(unsigned char *input, int size, int offset, int length) { return this->spi->engineDigest(input, size, offset, length); }
...
////////////////////////////////////////////////////////////////////////////////
void MessageDigest::update(unsigned char input) { this->spi->engineUpdate(input); }

////////////////////////////////////////////////////////////////////////////////
void MessageDigest::update(unsigned char *input, int size, int offset, int length) { this->spi->engineUpdate(input, size, offset, length); }

////////////////////////////////////////////////////////////////////////////////
void MessageDigest::update(const std::vector<unsigned char> &input) { this->spi->engineUpdate(input); }

////////////////////////////////////////////////////////////////////////////////
void MessageDigest::update(nio::ByteBuffer &input) { this->spi->engineUpdate(input); }
...
MessageDigest *MessageDigest::clone() {
  if (!this->spi->isCloneable()) {
    throw CloneNotSupportedException(__FILE__, __LINE__, "MessageDigestSpi in use not cloneable.");
  }
...
////////////////////////////////////////////////////////////////////////////////
void MessageDigest::reset() { this->spi->engineReset(); }

////////////////////////////////////////////////////////////////////////////////
std::string MessageDigest::toString() const { return std::string("MESSAGE DIGEST ") + algorithm; }
