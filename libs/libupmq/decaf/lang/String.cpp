...
String::String(const char value, int count) : contents() {
  if (count < 0) {
    throw StringIndexOutOfBoundsException(__FILE__, __LINE__, "count parameter out of Bounds: %d.", count);
  }
...
String::String(const char *array, int size) : contents() {
  if (size < 0) {
    throw StringIndexOutOfBoundsException(__FILE__, __LINE__, "size parameter out of Bounds: %d.", size);
  }
...
String::String(const char *array, int offset, int length) : contents() {
  ...
  if (offset > size || offset < 0) {
    throw StringIndexOutOfBoundsException(__FILE__, __LINE__, "offset parameter out of Bounds: %d.", offset);
  }

  if (length < 0 || length > size - offset) {
    throw StringIndexOutOfBoundsException(__FILE__, __LINE__, "length parameter out of Bounds: %d.", length);
  }
...
////////////////////////////////////////////////////////////////////////////////
bool String::operator==(const String &other) const { return this->equals(other); }

////////////////////////////////////////////////////////////////////////////////
bool String::operator==(const std::string &other) const { return this->equals(other); }

////////////////////////////////////////////////////////////////////////////////
bool String::operator==(const char *other) const { return this->equals(other); }
...
////////////////////////////////////////////////////////////////////////////////
bool String::operator<(const String &other) const { return this->compareTo(other) < 0; }

////////////////////////////////////////////////////////////////////////////////
bool String::operator<(const std::string &other) const { return this->compareTo(other) < 0; }

////////////////////////////////////////////////////////////////////////////////
bool String::operator<(const char *other) const { return this->compareTo(other) < 0; }
...
////////////////////////////////////////////////////////////////////////////////
String String::operator+(const String &other) const { return this->concat(other); }

////////////////////////////////////////////////////////////////////////////////
String String::operator+(const std::string &other) const { return this->concat(other); }

////////////////////////////////////////////////////////////////////////////////
String String::operator+(const char *other) const { return this->concat(other); }
...
const char *String::c_str() const {
  ...
  System::arraycopy(contents->value.get(), contents->offset, newContents->value.get(), 0, contents->length);
...
char String::charAt(int index) const {
  try {
    if (index < 0 || index >= this->length()) {
      throw StringIndexOutOfBoundsException(__FILE__, __LINE__, "Index given is out of bounds: %d.", index);
    }
...
int String::compareTo(const String &string) const {
  ...
  int end = contents->offset + (contents->length < string.contents->length ? contents->length : string.contents->length);
...
int String::compareTo(const std::string &string) const {
  ...
  int end = contents->offset + (contents->length < (int)string.length() ? contents->length : (int)string.length());
...
String String::concat(const String &string) const {
  ...
  System::arraycopy(string.contents->value.get(), string.contents->offset, buffer.value.get(), contents->length, string.contents->length);
...
////////////////////////////////////////////////////////////////////////////////
bool String::contains(const String &string) const { return indexOf(string) >= 0; }

////////////////////////////////////////////////////////////////////////////////
bool String::contains(const std::string &string) const { return indexOf(string) >= 0; }

////////////////////////////////////////////////////////////////////////////////
bool String::contains(const char *string) const { return indexOf(string) >= 0; }

////////////////////////////////////////////////////////////////////////////////
bool String::endsWith(const String &suffix) const { return regionMatches(contents->length - suffix.contents->length, suffix, 0, suffix.contents->length); }
...
////////////////////////////////////////////////////////////////////////////////
int String::findFirstOf(const String &chars) const { return findFirstOf(chars, 0); }
...
////////////////////////////////////////////////////////////////////////////////
int String::findFirstNotOf(const String &chars) const { return findFirstNotOf(chars, 0); }
...
void String::getChars(int srcBegin, int srcEnd, char *dest, int destSize, int destBegin) const {
  if (srcBegin < 0 || srcBegin > srcEnd || srcEnd > contents->length) {
    throw StringIndexOutOfBoundsException(__FILE__, __LINE__, "Invalid start or end parameters: %d, %d", srcBegin, srcEnd);
  }

  if (destSize < 0 || destBegin < 0 || (destBegin + (srcEnd - srcBegin)) > destSize) {
    throw StringIndexOutOfBoundsException(__FILE__, __LINE__, "Invalid destination size or offset parameters: %d, %d", destSize, destBegin);
  }
  ...
  System::arraycopy(contents->value.get(), srcBegin + contents->offset, dest, destBegin, srcEnd - srcBegin);
}
...
////////////////////////////////////////////////////////////////////////////////
bool String::isEmpty() const { return this->contents->length == 0; }

////////////////////////////////////////////////////////////////////////////////
bool String::isNullOrEmpty(const char *string) { return string == nullptr || StringUtils::stringLength(string) == 0; }

////////////////////////////////////////////////////////////////////////////////
int String::indexOf(char value) const { return indexOf(value, 0); }
...
////////////////////////////////////////////////////////////////////////////////
int String::indexOf(const String &string) const { return indexOf(string, 0); }
...
////////////////////////////////////////////////////////////////////////////////
int String::indexOf(const std::string &string) const { return indexOf(string, 0); }
...
////////////////////////////////////////////////////////////////////////////////
int String::indexOf(const char *string) const { return indexOf(string, 0); }
...
////////////////////////////////////////////////////////////////////////////////
int String::lastIndexOf(char value) const { return lastIndexOf(value, contents->length - 1); }
...
////////////////////////////////////////////////////////////////////////////////
int String::length() const { return this->contents->length; }
...
////////////////////////////////////////////////////////////////////////////////
bool String::startsWith(const String &prefix) const { return regionMatches(0, prefix, 0, prefix.contents->length); }

////////////////////////////////////////////////////////////////////////////////
bool String::startsWith(const String &prefix, int start) const { return regionMatches(start, prefix, 0, prefix.contents->length); }
...
CharSequence *String::subSequence(int start DECAF_UNUSED, int end DECAF_UNUSED) const {
  try {
    if (start > end) {
      throw StringIndexOutOfBoundsException(__FILE__, __LINE__, "Start index is greater than end index.");
    }

    if (end - start > this->length()) {
      throw StringIndexOutOfBoundsException(__FILE__, __LINE__, "Requested Range is greater than the String length.");
    }
...
////////////////////////////////////////////////////////////////////////////////
String String::valueOf(char value) { return String(&value, 1); }

////////////////////////////////////////////////////////////////////////////////
String String::valueOf(float value) { return String(Float::toString(value)); }
...
////////////////////////////////////////////////////////////////////////////////
String String::valueOf(long long value) { return String(Long::toString(value)); }
...
bool operator==(const std::string &left, const String &right) { return right.equals(left); }

bool operator==(const char *left, const String &right) { return right.equals(left); }

bool operator!=(const std::string &left, const String &right) { return !right.equals(left); }

bool operator!=(const char *left, const String &right) { return !right.equals(left); }

bool operator<(const std::string &left, const String &right) { return right.compareTo(left) > 0; }

bool operator<(const char *left, const String &right) { return right.compareTo(left) > 0; }
