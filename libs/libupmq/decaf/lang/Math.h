...
class DECAF_API Math {
 ...
 public:
   ...
   * @return the value if positive, otherwise the negative of value
   */
  static long long abs(long long value) { return value < 0 ? -value : value; }
   ...
   */
  static double toRadians(double angdeg) { return angdeg / 180 * PI; }
   ...
   */
  static double toDegrees(double angrad) { return angrad * 180 / PI; }
