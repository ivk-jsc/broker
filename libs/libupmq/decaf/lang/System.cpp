...
void System::initSystem(int argc DECAF_UNUSED, char **argv DECAF_UNUSED) {
  ...
  DECAF_UNUSED_VAR(argc);
  DECAF_UNUSED_VAR(argv);
...
////////////////////////////////////////////////////////////////////////////////
void System::arraycopy(const char *src, std::size_t srcPos, char *dest, std::size_t destPos, std::size_t length) {
  if (src == nullptr) {
    throw NullPointerException(__FILE__, __LINE__, "Given Source Pointer was null.");
  }
...
////////////////////////////////////////////////////////////////////////////////
void System::arraycopy(const unsigned char *src, std::size_t srcPos, unsigned char *dest, std::size_t destPos, std::size_t length) {
  if (src == nullptr) {
    throw NullPointerException(__FILE__, __LINE__, "Given Source Pointer was null.");
  }
...
////////////////////////////////////////////////////////////////////////////////
void System::arraycopy(const short *src, std::size_t srcPos, short *dest, std::size_t destPos, std::size_t length) {
  if (src == nullptr) {
    throw NullPointerException(__FILE__, __LINE__, "Given Source Pointer was null.");
  }
...
////////////////////////////////////////////////////////////////////////////////
void System::arraycopy(const int *src, std::size_t srcPos, int *dest, std::size_t destPos, std::size_t length) {
  if (src == nullptr) {
    throw NullPointerException(__FILE__, __LINE__, "Given Source Pointer was null.");
  }
...
////////////////////////////////////////////////////////////////////////////////
void System::arraycopy(const long long *src, std::size_t srcPos, long long *dest, std::size_t destPos, std::size_t length) {
  if (src == nullptr) {
    throw NullPointerException(__FILE__, __LINE__, "Given Source Pointer was null.");
  }
...
////////////////////////////////////////////////////////////////////////////////
void System::arraycopy(const float *src, std::size_t srcPos, float *dest, std::size_t destPos, std::size_t length) {
  if (src == nullptr) {
    throw NullPointerException(__FILE__, __LINE__, "Given Source Pointer was null.");
  }
...
////////////////////////////////////////////////////////////////////////////////
void System::arraycopy(const double *src, std::size_t srcPos, double *dest, std::size_t destPos, std::size_t length) {
  if (src == nullptr) {
    throw NullPointerException(__FILE__, __LINE__, "Given Source Pointer was null.");
  }
...
void System::unsetenv(const std::string &name) {
  try {
    ...
    throw NullPointerException(__FILE__, __LINE__, "System::unsetenv - %s", ex.what());
  }
}

////////////////////////////////////////////////////////////////////////////////
std::string System::getenv(const std::string &name) { return Poco::Environment::get(name); }
...
void System::setenv(const std::string &name, const std::string &value) {
  try {
    ...
    throw NullPointerException(__FILE__, __LINE__, "System::setenv - %s", ex.what());
  }
}
...
const Map<string, string> &System::getenv() {
  ...
  for (std::size_t i = 0; i < env.size(); i++) {
    ...
    if (tokens == 1) {
      ...
      throw IllegalArgumentException(__FILE__, __LINE__, "System::getenv - Invalid env string. %s", env[i].c_str());
    } else {
      // Normal case.
      key = tokenizer.nextToken();
...
std::string ws2s(const std::wstring &s) {
  ...
  const int len = WideCharToMultiByte(CP_ACP, 0, s.c_str(), slength, nullptr, 0, nullptr, nullptr);
  std::string r(len, '\0');
...
#define FreeEnvironmentStrings FreeEnvironmentStringsA
  ...
  LPTSTR lpszVars = (LPTSTR)lpvEnv;
  while (*lpszVars != 0) {
    count++;
    lpszVars += _tcslen(lpszVars) + 1;
  }
  ...
  while (*lpszVars != 0) {
#ifdef UNICODE
    buffer.push_back(ws2s(lpszVars));
#else
...
int System::availableProcessors() {
  ...
  numCpus = (int)mpctl(MPC_GETNUMSPUS, nullptr, nullptr);
#else
...
////////////////////////////////////////////////////////////////////////////////
decaf::util::Properties &System::getProperties() { return System::sys->systemProperties; }

////////////////////////////////////////////////////////////////////////////////
std::string System::getProperty(const std::string &key) {
  if (key.empty()) {
    throw IllegalArgumentException(__FILE__, __LINE__, "Cannot pass an empty key to getProperty.");
  }
...
std::string System::setProperty(const std::string &key, const std::string &value) {
  if (key.empty()) {
    throw IllegalArgumentException(__FILE__, __LINE__, "Cannot pass an empty key to setProperty.");
  }
...
std::string System::clearProperty(const std::string &key) {
  if (key.empty()) {
    throw IllegalArgumentException(__FILE__, __LINE__, "Cannot pass an empty key to clearProperty.");
  }
