...
class DECAF_API Long : public Number, public Comparable<Long>, public Comparable<long long> {
 private:
 ...
 public:
   ...
   */
  bool equals(const Long &l) const { return this->value == l.value; }
   ...
   */
  virtual bool operator==(const Long &l) const { return this->value == l.value; }
   ...
   * @return true if the two Integer Objects have the same value.
   */
  bool equals(const long long &l) const { return this->value == l; }
   ...
   * @return true if this object is equal to the one passed.
   */
  virtual bool operator==(const long long &l) const { return this->value == l; }
   ...
   */
  virtual long long longValue() const { return this->value; }
 ...
 public:
   ...
   */
  static Long valueOf(long long value) { return Long(value); }
