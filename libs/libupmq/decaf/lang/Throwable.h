...
class DECAF_API Throwable : public std::exception {
 public:
  ...
  ~Throwable() noexcept override;

  Throwable(const Throwable &other) = default;

  Throwable(Throwable &&other) = default;

  Throwable &operator=(const Throwable &other) = default;

  Throwable &operator=(Throwable &&other) noexcept = default;

  Throwable(const std::exception &other) : std::exception(other) {}
