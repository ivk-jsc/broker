...
////////////////////////////////////////////////////////////////////////////////
float Math::abs(float value) { return Float::intBitsToFloat(Float::floatToIntBits(value) & 0x7FFFFFFF); }

////////////////////////////////////////////////////////////////////////////////
double Math::abs(double value) { return Double::longBitsToDouble(Double::doubleToLongBits(value) & 0x7FFFFFFFFFFFFFFFULL); }
...
float Math::min(float a, float b) {
  ...
  // min( +0.0,-0.0) == -0.0
  if (a == 0.0f && ((Float::floatToIntBits(a) | Float::floatToIntBits(b)) & 0x80000000) != 0) {
    return 0.0f * (-1.0f);
  }
...
double Math::min(double a, double b) {
  ...
  // min( +0.0,-0.0) == -0.0
  if (a == 0.0 && ((Double::doubleToLongBits(a) | Double::doubleToLongBits(b)) & 0x8000000000000000ULL) != 0) {
    return 0.0 * (-1.0);
  }
...
double Math::max(double a, double b) {
  ...
  // max( +0.0,-0.0) == +0.0
  if (a == 0.0f && ((Double::doubleToLongBits(a) & Double::doubleToLongBits(b)) & 0x80000000) == 0) {
    return 0.0f;
  }
