...
class DECAF_API Character : public Number, public Comparable<Character>, public Comparable<char> {
 private:
 ...
 public:
   ...
   */
  virtual int compareTo(const Character &c) const { return this->value < c.value ? -1 : (this->value > c.value) ? 1 : 0; }
   ...
   */
  virtual bool operator==(const Character &c) const { return this->value == c.value; }
   ...
   *         less than the passed in value.
   */
  virtual int compareTo(const char &c) const { return this->value < c ? -1 : (this->value > c) ? 1 : 0; }
   ...
   * @return true if this object is equal to the one passed.
   */
  virtual bool operator==(const char &c) const { return this->value == c; }
   ...
   */
  bool equals(const Character &c) const { return this->value == c.value; }

  /**
   * @return true if the two Characters have the same value.
   */
  bool equals(const char &c) const { return this->value == c; }
 ...
 public:
   ...
   */
  static Character valueOf(char value) { return Character(value); }
   ...
   */
  static bool isLowerCase(char c) { return c >= 'a' && c <= 'z'; }
   ...
   */
  static bool isUpperCase(char c) { return c >= 'A' && c <= 'Z'; }
   ...
   */
  static bool isLetter(char c) { return isUpperCase(c) || isLowerCase(c); }
   ...
   */
  static bool isISOControl(char c) { return (c >= 0 && c <= 0x1f) || ((unsigned char)c >= 0x7f && (unsigned char)c <= 0x9f); }
