...
class DECAF_API StringIndexOutOfBoundsException : public IndexOutOfBoundsException {
 public:
   ...
   */
  StringIndexOutOfBoundsException(const Exception &ex) noexcept;
   ...
   *      The Exception whose data is to be copied into this one.
   */
  StringIndexOutOfBoundsException(const StringIndexOutOfBoundsException &ex) noexcept;
   ...
   *      The Exception whose data is to be copied into this one.
   */
  StringIndexOutOfBoundsException(StringIndexOutOfBoundsException &&ex) noexcept;

  StringIndexOutOfBoundsException &operator=(const StringIndexOutOfBoundsException &exc);

  StringIndexOutOfBoundsException &operator=(StringIndexOutOfBoundsException &&exc) noexcept;
   ...
   */
  StringIndexOutOfBoundsException *clone() const override;

  ~StringIndexOutOfBoundsException() noexcept override;
};
}  // namespace exceptions
}  // namespace lang
}  // namespace decaf
