...
class DECAF_API Short : public Number, public Comparable<Short>, public Comparable<short> {
 private:
  // The short value
  short value;
 ...
 public:
   ...
   */
  bool equals(const Short &s) const { return this->value == s.value; }
   ...
   */
  virtual bool operator==(const Short &s) const { return this->value == s.value; }
   ...
   * @return true if the two Short Objects have the same value.
   */
  bool equals(const short &s) const { return this->value == s; }
   ...
   * @return true if this object is equal to the one passed.
   */
  virtual bool operator==(const short &s) const { return this->value == s; }
   ...
   * @return int the value of the receiver.
   */
  virtual short shortValue() const { return this->value; }
