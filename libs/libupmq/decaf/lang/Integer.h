...
class DECAF_API Integer : public Number, public Comparable<Integer>, public Comparable<int> {
 private:
 ...
 public:
   ...
   */
  bool equals(const Integer &i) const { return this->value == i.value; }
   ...
   */
  virtual bool operator==(const Integer &i) const { return this->value == i.value; }
   ...
   * @return true if the two Integer Objects have the same value.
   */
  bool equals(const int &i) const { return this->value == i; }
   ...
   * @return true if this object is equal to the one passed.
   */
  virtual bool operator==(const int &i) const { return this->value == i; }
   ...
   * @return int the value of the receiver.
   */
  virtual int intValue() const { return this->value; }
 ...
 public:
   ...
   */
  static Integer valueOf(int value) { return Integer(value); }
