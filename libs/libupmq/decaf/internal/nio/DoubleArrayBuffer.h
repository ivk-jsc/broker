...
class DECAF_API DoubleArrayBuffer : public decaf::nio::DoubleBuffer {
 ...
 public:
   ...
   */
  DoubleArrayBuffer(int size, bool readOnly_ = false);
   ...
   */
  DoubleArrayBuffer(double *array, int size, int offset_, int length_, bool readOnly_ = false);
   ...
   */
  DoubleArrayBuffer(const decaf::lang::Pointer<ByteArrayAdapter> &array, int offset_, int length_, bool readOnly_ = false);
