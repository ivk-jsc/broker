...
unsigned char *ByteArrayBuffer::array() {
  try {
    if (!this->hasArray()) {
      throw UnsupportedOperationException(__FILE__, __LINE__, "ByteArrayBuffer::arrayOffset() - This Buffer has no backing array.");
    }

    if (this->isReadOnly()) {
      throw decaf::nio::ReadOnlyBufferException(__FILE__, __LINE__, "ByteArrayBuffer::array() - Buffer is Read Only.");
    }
...
int ByteArrayBuffer::arrayOffset() const {
  try {
    ...
    if (this->isReadOnly()) {
      throw decaf::nio::ReadOnlyBufferException(__FILE__, __LINE__, "ByteArrayBuffer::arrayOffset() - Buffer is Read Only.");
    }
...
ByteArrayBuffer &ByteArrayBuffer::compact() {
  try {
    if (this->isReadOnly()) {
      throw decaf::nio::ReadOnlyBufferException(__FILE__, __LINE__, "ByteArrayBuffer::compact() - Buffer is Read Only.");
    }
...
unsigned char ByteArrayBuffer::get(int index) const {
  try {
    if ((index) >= this->limit()) {
      throw IndexOutOfBoundsException(__FILE__, __LINE__, "ByteArrayBuffer::get - Not enough data to fill request.");
    }
...
long long ByteArrayBuffer::getLong(int index) const {
  try {
    if ((offset + index + (int)sizeof(long long)) > this->limit()) {
      throw IndexOutOfBoundsException(__FILE__, __LINE__, "ByteArrayBuffer::getLong(i) - Not enough data to fill a long long.");
    }
...
int ByteArrayBuffer::getInt(int index) const {
  try {
    if ((offset + index + (int)sizeof(int)) > this->limit()) {
      throw IndexOutOfBoundsException(__FILE__, __LINE__, "ByteArrayBuffer::getInt(i) - Not enough data to fill an int.");
    };
...
short ByteArrayBuffer::getShort(int index) const {
  try {
    if ((offset + index + (int)sizeof(short)) > this->limit()) {
      throw IndexOutOfBoundsException(__FILE__, __LINE__, "ByteArrayBuffer::getShort(i) - Not enough data to fill a short.");
    }
...
ByteArrayBuffer &ByteArrayBuffer::put(int index, unsigned char value) {
  try {
    if (this->isReadOnly()) {
      throw decaf::nio::ReadOnlyBufferException(__FILE__, __LINE__, "ByteArrayBuffer::put(i,i) - Buffer is Read Only.");
    }

    if (index >= this->limit()) {
      throw IndexOutOfBoundsException(__FILE__, __LINE__, "ByteArrayBuffer::put(i,i) - Not enough data to fill request.");
    }
...
ByteArrayBuffer &ByteArrayBuffer::putLong(int index, long long value) {
  try {
    if (this->isReadOnly()) {
      throw decaf::nio::ReadOnlyBufferException(__FILE__, __LINE__, "ByteArrayBuffer::putLong() - Buffer is Read Only.");
    }
...
ByteArrayBuffer &ByteArrayBuffer::putInt(int index, int value) {
  try {
    if (this->isReadOnly()) {
      throw decaf::nio::ReadOnlyBufferException(__FILE__, __LINE__, "ByteArrayBuffer::putInt() - Buffer is Read Only.");
    }
...
ByteArrayBuffer &ByteArrayBuffer::putShort(int index, short value) {
  try {
    if (this->isReadOnly()) {
      throw decaf::nio::ReadOnlyBufferException(__FILE__, __LINE__, "ByteArrayBuffer::putShort() - Buffer is Read Only.");
    }
...
ByteArrayBuffer *ByteArrayBuffer::slice() const {
  try {
    return new ByteArrayBuffer(this->_array, this->offset + this->position(), this->remaining(), this->isReadOnly());
  }
  DECAF_CATCH_RETHROW(Exception)
  DECAF_CATCHALL_THROW(Exception)
}
