...
class DECAF_API FloatArrayBuffer : public decaf::nio::FloatBuffer {
 ...
 public:
   ...
   */
  FloatArrayBuffer(int size, bool readOnly_ = false);
   ...
   */
  FloatArrayBuffer(float *array, int size, int offset_, int length_, bool readOnly_ = false);
   ...
   */
  FloatArrayBuffer(const decaf::lang::Pointer<ByteArrayAdapter> &array, int offset_, int length_, bool readOnly_ = false);
