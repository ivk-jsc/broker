...
class DECAF_API ShortArrayBuffer : public decaf::nio::ShortBuffer {
 ...
 public:
   ...
   */
  ShortArrayBuffer(int size, bool readOnly_ = false);
   ...
   */
  ShortArrayBuffer(short *array, int size, int offset_, int length_, bool readOnly_ = false);
   ...
   */
  ShortArrayBuffer(const decaf::lang::Pointer<ByteArrayAdapter> &array, int offset_, int length_, bool readOnly_ = false);
