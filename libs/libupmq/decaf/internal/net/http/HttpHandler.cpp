...
////////////////////////////////////////////////////////////////////////////////
decaf::net::URLConnection *HttpHandler::openConnection(const decaf::net::URL &url DECAF_UNUSED, const decaf::net::Proxy *proxy) {
  DECAF_UNUSED_VAR(url);
  if (proxy == nullptr) {
...
////////////////////////////////////////////////////////////////////////////////
int HttpHandler::getDefaultPort() const { return 80; }
