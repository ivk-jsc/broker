...
////////////////////////////////////////////////////////////////////////////////
decaf::net::URLConnection *FileHandler::openConnection(const decaf::net::URL &url DECAF_UNUSED, const decaf::net::Proxy *proxy) {
  DECAF_UNUSED_VAR(url);
  if (proxy == nullptr) {
...
////////////////////////////////////////////////////////////////////////////////
int FileHandler::getDefaultPort() const { return 80; }
