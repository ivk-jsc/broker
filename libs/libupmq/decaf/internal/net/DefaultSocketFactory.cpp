...
////////////////////////////////////////////////////////////////////////////////
Socket *DefaultSocketFactory::createSocket(const decaf::net::InetAddress *host, int port, const decaf::net::InetAddress *ifAddress, int localPort) {
  try {
    // Ensure something is actually passed in for the URI
    if (host == nullptr) {
...
////////////////////////////////////////////////////////////////////////////////
Socket *DefaultSocketFactory::createSocket(const std::string &hostname, int port, const InetAddress *ifAddress, int localPort) {
  try {
    // Ensure something is actually passed in for the URI
    if (hostname.empty()) {
      throw SocketException(__FILE__, __LINE__, "uri not provided");
