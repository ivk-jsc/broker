...
ThreadLocalImpl::ThreadLocalImpl() : tlsKey(0) {
  ...
  if (tlsKey < 0) {
    throw RuntimeException(__FILE__, __LINE__, "Thread Local storage limit reached.");
  }
}
...
////////////////////////////////////////////////////////////////////////////////
void *ThreadLocalImpl::getRawValue() const { return Threading::getThreadLocalValue(this->tlsKey); }
...
////////////////////////////////////////////////////////////////////////////////
void ThreadLocalImpl::removeAll() { Threading::destoryThreadLocalSlot(this->tlsKey); }
