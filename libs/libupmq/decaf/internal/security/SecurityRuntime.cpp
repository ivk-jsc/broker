...
////////////////////////////////////////////////////////////////////////////////
SecurityRuntime *SecurityRuntime::securityRuntime = nullptr;
...
class SecurityRuntimeImpl {
 ...
 public:
  ...
  SecurityRuntimeImpl() : lock(), registry(), defaultProvider() { registry = new ServiceRegistry(); }
...
SecurityRuntime *SecurityRuntime::getSecurityRuntime() {
  if (SecurityRuntime::securityRuntime == nullptr) {
    throw IllegalStateException(__FILE__, __LINE__, "SecurityRuntime Runtime is not Initialized.");
  }
...
////////////////////////////////////////////////////////////////////////////////
Mutex *SecurityRuntime::getRuntimeLock() { return &(this->impl->lock); }

////////////////////////////////////////////////////////////////////////////////
ServiceRegistry *SecurityRuntime::getServiceRegistry() { return this->impl->registry; }
...
////////////////////////////////////////////////////////////////////////////////
void SecurityRuntime::shutdownSecurity() { delete SecurityRuntime::securityRuntime; }
