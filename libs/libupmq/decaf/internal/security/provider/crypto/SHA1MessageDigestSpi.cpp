...
class SHA1MessageDigestSpiImpl {
 ...
 public:
  SHA1MessageDigestSpiImpl() : state(), count(), data(), local() { reset(); }
...
////////////////////////////////////////////////////////////////////////////////
SHA1MessageDigestSpi::~SHA1MessageDigestSpi() { delete this->impl; }
...
////////////////////////////////////////////////////////////////////////////////
int SHA1MessageDigestSpi::engineGetDigestLength() { return DECAF_SHA1_DIGESTSIZE; }

////////////////////////////////////////////////////////////////////////////////
void SHA1MessageDigestSpi::engineUpdate(unsigned char input) { this->impl->update(&input, 1); }
...
////////////////////////////////////////////////////////////////////////////////
void SHA1MessageDigestSpi::engineReset() { this->impl->reset(); }
...
int SHA1MessageDigestSpi::engineDigest(unsigned char *buffer, int size, int offset, int length) {
  ...
  if (size < engineGetDigestLength()) {
    engineReset();
    throw DigestException(__FILE__, __LINE__, "The value of size parameter is less than the actual digest length.");
  }

  if (length < engineGetDigestLength()) {
    engineReset();
    throw DigestException(__FILE__, __LINE__, "The value of length parameter is less than the actual digest length.");
  }
