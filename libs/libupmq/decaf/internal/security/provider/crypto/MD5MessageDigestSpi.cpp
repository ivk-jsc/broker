...
class MD5MessageDigestSpiImpl {
 ...
 public:
  MD5MessageDigestSpiImpl() : state(), count(), buffer() { reset(); }
...
////////////////////////////////////////////////////////////////////////////////
MD5MessageDigestSpi::~MD5MessageDigestSpi() { delete this->impl; }
...
////////////////////////////////////////////////////////////////////////////////
int MD5MessageDigestSpi::engineGetDigestLength() { return DECAF_MD5_DIGESTSIZE; }

////////////////////////////////////////////////////////////////////////////////
void MD5MessageDigestSpi::engineUpdate(unsigned char input) { this->impl->update(&input, 1); }
...
////////////////////////////////////////////////////////////////////////////////
void MD5MessageDigestSpi::engineReset() { this->impl->reset(); }
