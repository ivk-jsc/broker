...
class MD4MessageDigestSpiImpl {
 ...
 public:
  MD4MessageDigestSpiImpl() : state(), count(), buffer() { reset(); }
...
////////////////////////////////////////////////////////////////////////////////
MD4MessageDigestSpi::~MD4MessageDigestSpi() { delete this->impl; }
...
////////////////////////////////////////////////////////////////////////////////
int MD4MessageDigestSpi::engineGetDigestLength() { return DECAF_MD4_DIGESTSIZE; }

////////////////////////////////////////////////////////////////////////////////
void MD4MessageDigestSpi::engineUpdate(unsigned char input) { this->impl->update(&input, 1); }
...
////////////////////////////////////////////////////////////////////////////////
void MD4MessageDigestSpi::engineReset() { this->impl->reset(); }
