...
class DECAF_API InetAddress {
 ...
 public:
   ...
   */
  virtual bool isAnyLocalAddress() const { return false; }
   ...
   */
  virtual bool isLoopbackAddress() const { return false; }
   ...
   */
  virtual bool isMulticastAddress() const { return false; }
   ...
   */
  virtual bool isLinkLocalAddress() const { return false; }
   ...
   */
  virtual bool isSiteLocalAddress() const { return false; }
   ...
   */
  virtual bool isMCGlobal() const { return false; }
   ...
   */
  virtual bool isMCNodeLocal() const { return false; }
   ...
   */
  virtual bool isMCLinkLocal() const { return false; }
   ...
   */
  virtual bool isMCSiteLocal() const { return false; }
   ...
   */
  virtual bool isMCOrgLocal() const { return false; }
