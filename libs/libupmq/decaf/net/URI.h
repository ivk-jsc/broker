...
class DECAF_API URI : public lang::Comparable<URI> {
 ...
 public:
   ...
   */
  int compareTo(const URI &value) const override;

  /**
   * @return true if this value is considered equal to the passed value.
   */
  bool equals(const URI &value) const override;
   ...
   */
  bool operator==(const URI &value) const override;
 ...
 private:
   ...
   */
  void parseURI(const std::string &aUri, bool forceServer);
