...
class DECAF_API URLConnection {
 ...
 public:
   ...
   */
  bool getAllowUserInteraction() const { return allowUserInteraction; }
   ...
   */
  std::string getContentEncoding() const { return getHeaderField("Content-Encoding"); }
   ...
   */
  int getContentLength() const { return getHeaderFieldInt("Content-Length", -1); }
   ...
   */
  std::string getContentType() const { return getHeaderField("Content-Type"); }
   ...
   */
  long long getDate() const { return getHeaderFieldDate("Date", 0); }
   ...
   */
  bool getDefaultUseCaches() const { return defaultUseCaches; }
   ...
   */
  bool getDoInput() const { return doInput; }
   ...
   */
  bool getDoOutput() const { return doOutput; }
   ...
   */
  long getExpiration() const { return long(getHeaderFieldDate("Expires", 0)); }
   ...
   */
  bool getUseCaches() const { return useCaches; }
   ...
   */
  virtual std::string toString() const { return std::string("URLConnection:") + url.toString(); }
   ...
   */
  long long getIfModifiedSince() const { return ifModifiedSince; }
 ...
 public:
   ...
   */
  static bool getDefaultAllowUserInteraction() { return defaultAllowUserInteraction; }
   ...
   *      the default value of the flag to be used for new connections.
   */
  static void setDefaultAllowUserInteraction(bool allows) { defaultAllowUserInteraction = allows; }
};
}  // namespace net
}  // namespace decaf
