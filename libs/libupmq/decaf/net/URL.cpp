...
////////////////////////////////////////////////////////////////////////////////
URL::URL(const String &url) : impl(new URLImpl) { initialize(nullptr, url, nullptr); }

////////////////////////////////////////////////////////////////////////////////
URL::URL(const URL &context, const String &spec) : impl(new URLImpl) { initialize(&context, spec, nullptr); }
...
void URL::initialize(const URL *context, const String &theSpec, URLStreamHandler *handler) {
  ...
  if (!protocol.isEmpty() && context != nullptr && !protocol.equals(context->getProtocol())) {
    context = nullptr;
  }
  ...
  if (context != nullptr) {
    ...
    throw MalformedURLException(__FILE__, __LINE__, (std::string("Protocol not found: ") + spec.toString()).c_str());
  }
  ...
  if (impl->streamHandler == nullptr) {
    ...
    if (impl->streamHandler == nullptr) {
      throw MalformedURLException(__FILE__, __LINE__, (std::string("unknown protocol: ") + impl->url.getProtocol().toString()).c_str());
    }
  }
  ...
  if (impl->url.getPort() < -1) {
    throw MalformedURLException(__FILE__, __LINE__, "port out of range: %d", impl->url.getPort());
  }
...
////////////////////////////////////////////////////////////////////////////////
void URL::initialize(const String &protocol, const String &host, int port, const String &file, URLStreamHandler *handler) {
  // If we throw in this method the constructor does not complete, so we
  // need to protect against a leak of the URLImpl and release at the end.
  Pointer<URLImpl> finalizer(impl);
  ...
  if (protocol.isEmpty()) {
    throw NullPointerException(__FILE__, __LINE__, "Unknown protocol: %s", "NULL");
  }
  ...
  if (handler == nullptr) {
    impl->setupStreamHandler();
    if (impl->streamHandler == nullptr) {
      throw MalformedURLException(__FILE__, __LINE__, (std::string("Unknown protocol: ") + protocol.toString()).c_str());
    }
  } else {
    impl->streamHandler.reset(handler);
  }
...
////////////////////////////////////////////////////////////////////////////////
bool URL::equals(const URL &other) const { return impl->streamHandler->equals(*this, other); }

////////////////////////////////////////////////////////////////////////////////
String URL::getAuthority() const { return impl->url.getAuthority(); }

////////////////////////////////////////////////////////////////////////////////
int URL::getDefaultPort() const { return impl->streamHandler->getDefaultPort(); }

////////////////////////////////////////////////////////////////////////////////
String URL::getFile() const { return impl->url.getFile(); }

////////////////////////////////////////////////////////////////////////////////
String URL::getHost() const { return impl->url.getHost(); }

////////////////////////////////////////////////////////////////////////////////
String URL::getPath() const { return impl->url.getPath(); }

////////////////////////////////////////////////////////////////////////////////
String URL::getUserInfo() const { return impl->url.getUserInfo(); }

////////////////////////////////////////////////////////////////////////////////
int URL::getPort() const { return impl->url.getPort(); }

////////////////////////////////////////////////////////////////////////////////
String URL::getProtocol() const { return impl->url.getProtocol(); }

////////////////////////////////////////////////////////////////////////////////
String URL::getQuery() const { return impl->url.getQuery(); }

////////////////////////////////////////////////////////////////////////////////
String URL::getRef() const { return impl->url.getRef(); }
...
////////////////////////////////////////////////////////////////////////////////
URLConnection *URL::openConnection() { return impl->streamHandler->openConnection(*this); }
...
InputStream *URL::openStream() {
  return nullptr;  // TODO figure out Connection lifetime
}

////////////////////////////////////////////////////////////////////////////////
bool URL::sameFile(const URL &other) const {
  if (impl->streamHandler == nullptr) {
    throw MalformedURLException(__FILE__, __LINE__, (std::string("Unknown protocol: ") + getProtocol().toString()).c_str());
  }
...
////////////////////////////////////////////////////////////////////////////////
std::string URL::toString() const { return toExternalForm().toString(); }

////////////////////////////////////////////////////////////////////////////////
URI URL::toURI() const { return URI(this->toString()); }
...
////////////////////////////////////////////////////////////////////////////////
URLStreamHandler *URL::getURLStreamHandler() const { return this->impl->streamHandler.get(); }
