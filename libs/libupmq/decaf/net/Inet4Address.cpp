...
////////////////////////////////////////////////////////////////////////////////
InetAddress *Inet4Address::clone() const { return new Inet4Address(*this); }
...
////////////////////////////////////////////////////////////////////////////////
bool Inet4Address::isLoopbackAddress() const { return this->addressBytes[0] == 127; }

////////////////////////////////////////////////////////////////////////////////
bool Inet4Address::isMulticastAddress() const { return (this->addressBytes[0] & 0xF0) == 0xE0; }

////////////////////////////////////////////////////////////////////////////////
bool Inet4Address::isLinkLocalAddress() const { return ((this->addressBytes[0] == 169) && (this->addressBytes[1] == 254)); }
...
////////////////////////////////////////////////////////////////////////////////
bool Inet4Address::isMCLinkLocal() const { return (InetAddress::bytesToInt(addressBytes.get(), 0) >> 8) == 0xE00000; }

////////////////////////////////////////////////////////////////////////////////
bool Inet4Address::isMCSiteLocal() const { return (InetAddress::bytesToInt(addressBytes.get(), 0) >> 16) == 0xEFFF; }
