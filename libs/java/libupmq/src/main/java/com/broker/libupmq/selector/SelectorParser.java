...
import com.broker.libupmq.selector.filter.ArithmeticExpression;
import com.broker.libupmq.selector.filter.BooleanExpression;
import com.broker.libupmq.selector.filter.ComparisonExpression;
import com.broker.libupmq.selector.filter.ConstantExpression;
import com.broker.libupmq.selector.filter.Expression;
import com.broker.libupmq.selector.filter.LogicExpression;
import com.broker.libupmq.selector.filter.PropertyExpression;
import com.broker.libupmq.selector.filter.UnaryExpression;
...
public class SelectorParser implements SelectorParserConstants {
	...
	private BooleanExpression asBooleanExpression(com.broker.libupmq.selector.filter.Expression value) throws ParseException {
	...
	final public com.broker.libupmq.selector.filter.Expression addExpression() throws ParseException {
		Expression left;
		Expression right;
		left = multExpr();
		label_7: while (true) {
