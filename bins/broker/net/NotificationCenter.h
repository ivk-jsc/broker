...
#ifndef UPMQ_Foundation_NotificationCenter_INCLUDED
#define UPMQ_Foundation_NotificationCenter_INCLUDED
...
///     }
{
 public:
  ...
  static upmq::NotificationCenter& defaultCenter();
 ...
 private:
  ...
  mutable upmq::MRWLock _mutex;
};

}  // namespace upmq

#endif  // UPMQ_Foundation_NotificationCenter_INCLUDED
